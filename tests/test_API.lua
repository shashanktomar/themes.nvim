...
T["setup()"]["sets exposed methods and default options value"] = function()
  child.lua([[require('themes').setup()]])

  -- global object that holds your plugin information
  eq_type_global(child, "_G.Themes", "table")

  -- public methods
  eq_type_global(child, "_G.Themes.toggle", "function")
  eq_type_global(child, "_G.Themes.disable", "function")
  eq_type_global(child, "_G.Themes.enable", "function")

  -- config
  eq_type_global(child, "_G.Themes.config", "table")
